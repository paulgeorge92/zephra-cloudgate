...
let PrismaService = class PrismaService extends client_1.PrismaClient {
    constructor() {
        ...
        const resolvedPath = path_1.default.isAbsolute(dbRelPath) ? dbRelPath : path_1.default.resolve(process.cwd(), dbRelPath);
        fs_1.default.mkdirSync(path_1.default.dirname(resolvedPath), { recursive: true });
        const adapter = new adapter_better_sqlite3_1.PrismaBetterSqlite3({ url: resolvedPath });
        super({ adapter });
    }
    async onModuleInit() {
        await this.$connect();

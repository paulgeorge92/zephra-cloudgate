...
const cloudflare_controller_1 = require("./cloudflare.controller");
...
exports.CloudflareModule = CloudflareModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [cloudflare_controller_1.CloudflareController],
        providers: [cloudflare_service_1.CloudflareService],
